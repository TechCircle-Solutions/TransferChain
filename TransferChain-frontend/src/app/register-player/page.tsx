...
const Address = process.env.NEXT_PUBLIC_PLAYER_REGISTRY || '0x49335199e4121fc332cb5b11ce704250dea92cc8';
    ...
    try {
      ...
      writeContract({
        ...
        onSuccess: (txHash) => {
          ...
          toast.success(`Player "${currentPlayerName}" registered successfully on PlayerRegistry!`);
        },
        onError: (err) => {
          setLoading(false);
